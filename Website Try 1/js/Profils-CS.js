function demarrage() {
	...
	xhr.open('get', "http://localhost/json?url=Profils-CSS", true) ; 
	...
	for (let i = 0 ; i < reponse.length ; i++) {
		...
		if (reponse[i]['portrait'] == null) {
			...
			fiche += "<div class='personne'>\
						 ...
						 <div id='profil_bouton'><a href='PageProfilPublic-CB'><input type='button' value='Voir le profil' class='compte_bouton'></a></div>\
						 </div></div>" ;
	}
	return fiche ;
}
