...
RESULT (nom VARCHAR(50),prenom VARCHAR(50),mail VARCHAR (60), telephone VARCHAR (15), ville VARCHAR(50), tache long VARCHAR, details LONG VARCHAR, categorie VARCHAR (30))

BEGIN

   call sa_set_http_header('Access-Control-Allow-Origin', '*');

   select nom, prenom, mail, telephone, ville, tache, details, categorie
